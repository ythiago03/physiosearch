...
const Home = () => {
  ...
  const [seeBones, setSeeBones] = useState(true);
  const [seeMuscle, setSeeMuscle] = useState(true);
  const [seeLigamento, setLigamento] = useState(true);
      ...
      <section className='home_wrapper'>
        ...
        >
          <TransformComponent>
            ...
            {seeMuscle &&
            <img className='skeleton-full2' src="src/assets/human_body_muscle-removebg.png" alt="Esqueleto do corpo humano" />
            }
            {seeLigamento &&
            <img className='skeleton-joelho' src="src/assets/joelho.png" alt="" />
            }
